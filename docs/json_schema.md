...
| 필드 | 타입 | 필수 | 설명 |
|---|---|---|---|
| `standard_id` | `str` | ✅ | `"ISA-<standard_no>"` 포맷. 전역 고유. |
| `standard_no` | `str` | ✅ | 숫자 문자열 `"200"` ~ `"1200"`. MD frontmatter 동일. |
...
```json
{
  ...
  "properties": {
    ...
    "standard": {
      ...
      "additionalProperties": false,
      "properties": {
        "standard_id": {"type": "string", "pattern": "^ISA-\\d{3,4}$"},
        "standard_no": {"type": "string", "pattern": "^\\d{3,4}$"},
